...
public class UserConversationPOJO {
    ...
    private static final String DB__MESSAGE__ID         = "message_id";
    ...
    @Nullable private volatile Integer id;

    @Column(name = DB__USER__ID)
    @Nullable private volatile Integer user_id;
    ...
    public UserConversationPOJO(
            @JsonProperty(JSON__USER__ID) @Nullable Integer user_id,
    ...
    public void setMessage(UserMessagePOJO message) {
